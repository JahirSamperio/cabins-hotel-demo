...
export const getStats = async (req, res) => {
    try {
        ...
        const [monthlyStats, monthlyStaysStats, lastMonthStats, todayStats, cabinStats, reviewStats] = await Promise.all([
        ...
        res.json({
            ...
            stats: {
                ...
                // Métricas de gestión
                pendingReservations: parseInt(currentMonth.pendingReservations) || 0,
